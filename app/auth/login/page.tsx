    ...
    <div className="flex-1 flex flex-col h-full">
      ...
      <div className="p-3 px-5 w-full flex-1 h-fullitems-center justify-center flex flex-col">
        ...
        >
          ...
          <Button className="bg-black text-white py-6">Login</Button>
        </form>
        <div className="py-5 w-full flex items-center justify-center">
          <h5 className="text-sm">Don&apos;t have an account ? <Link className="font-semibold" href={LINKS.register}>Register</Link></h5>
        </div>
